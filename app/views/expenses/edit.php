    ...
    <?php require_once APPROOT.'/views/components/sidebar.php';  ?>
      ...
      <?php require_once APPROOT.'/views/components/menu.php';  ?>
        ...
        <div class="row">
            ...
            <div class="col-md-7">
                <form action="<?php echo URLROOT.'/expense/update/'.$data['expense']['id']?>" method="POST">
                <div class="form-group row">
                    <label for="amount" class="col-sm-2 col-form-label">Amount</label>
                    <div class="col-sm-10">
                    <input type="number" class="form-control" id="amount" name="amount" value="<?php echo $data['expense']['amount'] ?>" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="qty" class="col-sm-2 col-form-label">Qty</label>
                    <div class="col-sm-10">
                    <input type="number" class="form-control" id="qty" name="qty" value="<?php echo $data['expense']['qty'] ?>" required>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <input type="date" class="form-control" id="date" name="date" value="<?php echo $data['expense']['date'] ?>" required>
                    </div>
                </div>
